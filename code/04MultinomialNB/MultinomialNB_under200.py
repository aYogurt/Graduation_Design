...
def getPreResult(dataTrain_list, labelTrain_list,dataTest_list,labelTest_list, stopWordList):
    ...
    # print("对训练集进行模型评估：")
    # ytrain_pred = MulNB_model.predict(tfidfTrain)
    # print("classification_report: ")
    # print(classification_report(labelTrain_list, ytrain_pred))
    # print("\n")
    # scoreTrian = MulNB_model.score(tfidfTrain, labelTrain_list)
    ...
    # print("")
    # print("对测试集进行模型评估：")
    # ytest_pred = MulNB_model.predict(tfidfTest)
    # print("classification_report: ")
    # print(classification_report(labelTest_list, ytest_pred))
    # print("\n")
    # scoreTest = MulNB_model.score(tfidfTest, labelTest_list)
    ...
    with open('..\\Model\\Experiment1.model', 'rb+') as file:
        save = {
