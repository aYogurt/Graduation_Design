...
# print(type(tfidfTrain)) #<class 'scipy.sparse.csr.csr_matrix'>
print((tfidfTrain.toarray()).shape)
print((tfidfTrain.toarray()).shape[1])

# model = OneVsRestClassifier(svm.SVC(kernel='linear'))
# clf = model.fit(tfidfTrain, label_list)

# scores = cross_val_score(clf, tfidfTrain, label_list, cv=5)
# print('kfold=5的分数为: ', scores)
# scoring = ['precision_macro', 'recall_macro']
# scores = cross_validate(clf, tfidfTrain, label_list, scoring=scoring, cv=5, return_train_score=True)
# sorted(scores.keys())
