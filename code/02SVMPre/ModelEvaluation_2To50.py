...
def getPreResult(dataTrain_list, labelTrain_list,dataTest_list,labelTest_list, stopWordList):
    ...
    # print("score : ",clf.score(tfidfTrain, labelTrain_list))
    ...
    # print("对训练集进行模型评估, Start running time: %s" % start04)
    ...
    # print("score : ", clf.score(tfidfTest, labelTest_list))
...
if __name__ == '__main__':
  ...
  # 你运行的程序，也就是你的代码块，或者函数
    ...
    # 训练集的特征、标签列表
    fileTrainPath = "B:\\code_master\\code\\00DataSet\\dataTrainSet_2To50"
    dataTrain_list, labelTrain_list = getDataLabelList(fileTrainPath)
    # 测试集的特征、标签列表
    fileTestPath = "B:\\code_master\\code\\00DataSet\\dataTestSet_2To50"
