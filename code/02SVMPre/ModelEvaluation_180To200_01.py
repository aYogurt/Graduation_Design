...
def getTxtFile(inputpath):
    ...
    return filename
    # print(num)
# filepath = "G:\\dataTrainSet"
# fatherLists = getTxtFile(filepath)
# print(len(fatherLists))  #  104
# print(fatherLists)
...
def getPreResult(dataTrain_list, labelTrain_list,dataTest_list,labelTest_list, stopWordList):
    ...
    #对测试集向量化
    cipinTest = vectorizer.fit_transform(dataTest_list)
    tfidfTest = transformer.fit_transform(cipinTest)
